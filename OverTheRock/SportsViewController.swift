...
class SportsViewController: UIViewController, SportsFeedModelDelegate, UITableViewDelegate, UITableViewDataSource {
    
    let feedModel:SportsFeedModel = SportsFeedModel()
